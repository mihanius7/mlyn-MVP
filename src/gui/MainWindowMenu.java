...
public class MainWindowMenu extends JMenuBar {
	...
	public MainWindowMenu() {
		...
		menuItemOpen = new JMenuItem(GUIStrings.MENU_OPEN);
		menuItemOpen.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O, ActionEvent.CTRL_MASK));
		menuItemOpen.addActionListener(mwme);
		menu.add(menuItemOpen);

		menuItemSave = new JMenuItem(GUIStrings.MENU_SAVE);
		...
		menuItemClear = new JMenuItem(GUIStrings.MENU_CLEAR_ALL);
		...
		menuItemExit = new JMenuItem(GUIStrings.MENU_EXIT);
		menu.add(menuItemExit);
		menuItemExit.addActionListener(mwme);
		
		menu = new JMenu(GUIStrings.MENU_EDIT);
		add(menu);
		
		rbMenuItemMouse1p = new JRadioButtonMenuItem(GUIStrings.MENU_SELECT_PARTICLES);
		...
		rbMenuItemMouse1s = new JRadioButtonMenuItem(
				GUIStrings.MENU_SELECT_SPRINGS);
		...
		menuItemSelectAll = new JMenuItem(GUIStrings.MENU_SELECT_ALL_PARTICLES);
		...
		menuItemCOM = new JMenuItem(GUIStrings.MENU_CENTER_OF_MASS);
		...
		menuItemSnapToGrid = new JMenuItem(GUIStrings.MENU_SNAP_TO_GRID);
		...
		menu = new JMenu(GUIStrings.MENU_ADD);
		add(menu);
		
		rbMenuItemMouse2p = new JRadioButtonMenuItem(GUIStrings.MENU_ADD_PARTICLE);
		...
		rbMenuItemMouse2s = new JRadioButtonMenuItem(GUIStrings.MENU_ADD_SPRING);
		...
		menu = new JMenu(GUIStrings.MENU_SIMULATION);
		menu.setMnemonic(KeyEvent.VK_S);
		add(menu);		

		menuItemStart = new JMenuItem(GUIStrings.MENU_START_PAUSE);
		...
		menuItemStep = new JMenuItem(GUIStrings.MENU_FEW_STEPS);
		...
		JMenu submenu = new JMenu(GUIStrings.MENU_CONSIDER);
		menu.add(submenu);		

		cbMenuItem1pp = new JCheckBoxMenuItem(GUIStrings.MENU_PP_COLLISIONS);
		cbMenuItem1pp.setMnemonic(KeyEvent.VK_C);
		cbMenuItem1pp.addActionListener(mwme);
		submenu.add(cbMenuItem1pp);

		cbMenuItem3 = new JCheckBoxMenuItem(GUIStrings.MENU_OUTER_FORCES);
		...
		cbMenuItem3fr = new JCheckBoxMenuItem(GUIStrings.MENU_FRICTION);
		...
		menuItemFreeze = new JMenuItem(GUIStrings.MENU_NULLIFY_VELOCITIES);
		...
		menuItemBoundaries = new JMenuItem(GUIStrings.MENU_SIMULATION_BOUNDS);
		menuItemBoundaries.addActionListener(mwme);
		menu.add(menuItemBoundaries);

		menu = new JMenu(GUIStrings.MENU_SHOW);
		menu.setMnemonic(KeyEvent.VK_V);
		add(menu);

		menuItemAutoscale = new JMenuItem(GUIStrings.MENU_ZOOM_TO_PARTICLES);
		menuItemAutoscale
		...
		menuItemViewAll = new JMenuItem(GUIStrings.MENU_ZOOM_TO_BOUNDARIES);
		menuItemViewAll
		...
		menuItemFollowParticle = new JMenuItem(GUIStrings.MENU_FOLLOW_PARTICLE);
		...
		cbMenuItem4 = new JCheckBoxMenuItem(GUIStrings.MENU_VELOCITIES);
		cbMenuItem4.addActionListener(mwme);
		menu.add(cbMenuItem4);

		cbMenuItem5 = new JCheckBoxMenuItem(GUIStrings.MENU_FORCES);
		cbMenuItem5.addActionListener(mwme);
		menu.add(cbMenuItem5);

		cbMenuItem7 = new JCheckBoxMenuItem(GUIStrings.MENU_PRETTY);
		cbMenuItem7.addActionListener(mwme);
		menu.add(cbMenuItem7);

		cbMenuItem8 = new JCheckBoxMenuItem(GUIStrings.MENU_TAGS);
		cbMenuItem8.addActionListener(mwme);
		menu.add(cbMenuItem8);

		cbMenuItem9 = new JCheckBoxMenuItem(GUIStrings.MENU_GRID);
		...
		cbMenuItem10 = new JCheckBoxMenuItem(GUIStrings.MENU_PARTICLE_TRACKS);
		...
		menuItemSaveScrn = new JMenuItem(GUIStrings.MENU_TAKE_SCREENSHOT);
		...
		menu = new JMenu(GUIStrings.MENU_CONTROL);
		menu.setMnemonic(KeyEvent.VK_S);
		add(menu);
		
		submenu = new JMenu(GUIStrings.MENU_MOUSE);
		menu.add(submenu);

		rbMenuItemMouse3p = new JRadioButtonMenuItem(GUIStrings.MENU_CONTROL_BY_FORCE);
		...
		rbMenuItemMouse4p = new JRadioButtonMenuItem(GUIStrings.MENU_CONTROL_BY_PLACE);
		...
		menu = new JMenu(GUIStrings.MENU_HELP);
		add(menu);
		
		menuItemAbout = new JMenuItem(GUIStrings.MENU_ABOUT);
